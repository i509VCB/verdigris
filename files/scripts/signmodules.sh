...
# if [ ! -z "${GITHUB_ACTIONS}" ]
  ...
  cp ../system/etc/pki/akmods/certs/public_key.der.test ./files/system/etc/pki/akmods/certs/akmods-verdigris.der
  cp ../system/etc/pki/akmods/certs/private_key.priv.test /tmp/certs/private_key.priv
# fi

KERNEL_VERSION="$(rpm -q "kernel" --queryformat '%{VERSION}-%{RELEASE}.%{ARCH}')"

PUBLIC_KEY_DER_PATH="../system/etc/pki/akmods/certs/akmods-verdigris.der"
